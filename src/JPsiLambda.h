...
class JPsiLambda : public edm::one::EDAnalyzer<> {
public:
  explicit JPsiLambda(const edm::ParameterSet&);
  ~JPsiLambda();
...
private:
  ...
  std::vector<float>       *lambda_chi2, *J_chi2, *lB_chi2;
  std::vector<float>       *lB_Prob, *J_Prob, *lambda_Prob;
