...
#process.GlobalTag = GlobalTag(process.GlobalTag, '124X_dataRun3_PromptAnalysis_v1') #2022 C D
#process.GlobalTag = GlobalTag(process.GlobalTag, '124X_dataRun3_Prompt_v10') #2022 E 
process.GlobalTag = GlobalTag(process.GlobalTag, '124X_dataRun3_PromptAnalysis_v2') #2022 F G
...
process.TFileService = cms.Service("TFileService",
       ...
       fileName = cms.string('Rootuple_Bc-MiniAOD.root'),
